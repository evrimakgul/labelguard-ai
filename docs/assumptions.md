...
12. Podman 6.0.2 is the selected free OCI engine. Its rootless WSL2 machine, image build, container process startup, and internal health pass; Windows host forwarding remains under diagnosis.
