"""Measure deterministic local pipeline overhead without claiming live OCR performance."""
    ...
    try:
        with TestClient(app) as client:
            for _ in range(20):
                ...
                api_times.append(float(response.json()["processingTimeMs"]))
    finally:
